...
#define MAX_ELEMENTS_PER_THREAD_FOR_COMFORT_TEST (100000000)
...
void benchmark_wfext(int n_threads) {
    ...
    std::ofstream outfile("test_for_WFEXT_num_of_threads_" + std::to_string(num_threads));
